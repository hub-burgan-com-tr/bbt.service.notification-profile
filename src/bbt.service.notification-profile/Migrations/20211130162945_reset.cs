    ...
    public partial class reset : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { new Guid("1e15d57c-26e3-4e78-94f9-8649b3302555"), 123456L, null, null, "Message.data.amount >= 500 && Message.data.iban ==\"TR1234567\"", false, false, true, "[SAMPLE]Incoming-EFT", 123456L, 90, 3855206, 530 });
            ...
            migrationBuilder.InsertData(
                table: "Consumers",
                columns: new[] { "Id", "Client", "DeviceKey", "Email", "Filter", "IsEmailEnabled", "IsPushEnabled", "IsSmsEnabled", "SourceId", "User", "Phone_CountryCode", "Phone_Number", "Phone_Prefix" },
                values: new object[] { new Guid("3e15d57c-26e3-4e78-94f9-8649b3302555"), 0L, null, null, "Message.data.amount >= 500000", false, false, true, "[SAMPLE]Incoming-EFT", 123456L, 90, 3855206, 530 });
