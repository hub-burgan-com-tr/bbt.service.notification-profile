...
{
    public partial class AddSourceTableRetentionTimeColumnS : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Sources",
                columns: new[] { "Id", "ApiKey", "ClientIdJsonPath", "DisplayType", "EmailServiceReference", "KafkaCertificate", "KafkaUrl", "ParentId", "PushServiceReference", "RetentationTime", "Secret", "SmsServiceReference", "Title_EN", "Title_TR", "Topic" },
                values: new object[] { 1, "", null, 1, "notify_email_incoming_eft", "x", "x", null, "notify_push_incoming_eft", 0, "", "9cab7fdc-76a4-44be-b6fa-101f13729875", "CashBackEN", "CashBackTR", "CAMPAIGN_CASHBACK_ACCOUNTING_INFO" });
